...
namespace CarStore.UnitTests
{
        ...
        public class CartTests
        {
            ...
            public void Can_Add_New_Lines()
            {
                ...
                Car car1 = new Car { CarId = 1, Name = "Car1" };
                Car car2 = new Car { CarId = 2, Name = "Car2" };
            ...
            public void Can_Remove_Line()
            {
                ...
                Car car1 = new Car { CarId = 1, Name = "Car1" };
                Car car2 = new Car { CarId = 2, Name = "Car2" };
                Car car3 = new Car { CarId = 1, Name = "Car1" };
            ...
            {
            // Организация - создание нескольких тестовых игр
                Car car1 = new Car { CarId = 1, Name = "Car1", Price = 100 };
                Car car2 = new Car { CarId = 2, Name = "Car2", Price = 55 };
